        ...
        <div className="border border-gray-700 p-4 rounded-lg bg-[#192339] text-center">
          ...
          <div className="flex flex-col items-center">
            ...
            <a
              ...
              className="mt-4 px-6 py-2 bg-linear-to-r from-cyan-500 to-cyan-400 hover:scale-105 text-white font-semibold rounded-lg transition-all duration-200 shadow-md"
            >
