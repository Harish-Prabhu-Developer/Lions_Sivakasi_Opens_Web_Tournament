// components/Academy/Player/PlayerFormModal.jsx
import React from "react";
import { User, Award, CalendarDays, MapPin, Loader2 } from "lucide-react";
...
const PlayerFormModal = ({ editingPlayer, playerForm, onInputChange, onSubmit, onClose, loading }) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Ensure we're passing the complete playerForm object
    onSubmit(e);
  };
